 ...
 */
public class TelaVerificarReservaUsuario extends javax.swing.JFrame {

    /**
     * Creates new form TelaVerificarReserva
     */
    public TelaVerificarReservaUsuario() {
        initComponents();
    }

    public void retornaPorCPF(String cpf){
        
         ReservaDAO rDAO = new ReservaDAO();
         Reserva reserva = new Reserva();
         
         
       reserva =  rDAO.buscaPorCPF(cpf);
    ...
    private void initComponents() {
        ...
        jLabel4.setFont(new java.awt.Font("Microsoft JhengHei UI Light", 0, 22)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Verificar Reserva");
        ...
        jLabel2.setText("Verifique sua reserva:");

        jPanel3.setBackground(new java.awt.Color(255, 255, 255));
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(""));
        jPanel3.setForeground(new java.awt.Color(255, 255, 255));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/iconeVerificarReserva.PNG"))); // NOI18N

        jLabel5.setFont(new java.awt.Font("Microsoft JhengHei UI Light", 0, 18)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(0, 0, 0));
        jLabel5.setText("Insira o seu CPF:");
...
public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaVerificarReservaUsuario
...
.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaVerificarReservaUsuario().setVisible(true);
            }
        });
